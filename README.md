Hi, my name is Ivan, I'm italian and "I'm not" a developer... I only "do" the developer, but just for fun! My works are more oriented on spreading Portable Linux Apps in particular by playing with AppImage packages, all this using some custom bash  scripts.
